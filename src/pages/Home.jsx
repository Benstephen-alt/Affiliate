  ...
  return (
    <main>
      ...
      <section className="featureGrid">
        ...
        <div className="featureCard"><span>02</span><h3>Retry rejected wallets</h3><p>If a wallet was not a StakersPro user before, upload it again after it becomes verified.</p></div>
